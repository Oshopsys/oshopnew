...
export default async function SalesInvoicesPage() {
    const invoices = await getInvoices('SALE');

    return (
        <div className="flex flex-col gap-4">
            <div className="flex items-center justify-between">
                <h1 className="text-2xl font-bold tracking-tight">فواتير البيع</h1>
                <Button asChild>
            ...
            <Card>
                <CardHeader className="py-4">
                    <CardTitle className="text-lg">قائمة الفواتير ({invoices?.length || 0})</CardTitle>
                </CardHeader>
                <CardContent>
